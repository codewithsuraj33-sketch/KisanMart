  ...
  return (
    <main className="relative flex min-h-screen flex-1 items-center justify-center overflow-hidden bg-ink px-4 py-12">
      ...
      <div className="relative w-full max-w-md rounded-3xl border border-white/10 bg-white p-7 shadow-[0_30px_80px_rgba(0,0,0,0.3)] sm:p-9">
        <div className="flex items-center justify-between"><span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-ink text-white"><ShieldCheck size={24} /></span><Link href="/" className="flex items-center gap-1.5 text-xs font-bold text-body hover:text-brand"><ArrowLeft size={14} /> Storefront</Link></div>
        <div className="mt-7"><div className="flex items-center gap-2 font-display text-sm font-extrabold"><Leaf className="text-brand" size={17} /><span className="text-brand">Kisan<span className="text-accent">Mart</span></span></div><h1 className="mt-3 text-3xl font-extrabold text-ink">Admin access</h1><p className="mt-2 text-sm leading-6 text-body">Sign in with an authorised administrator account.</p></div>
